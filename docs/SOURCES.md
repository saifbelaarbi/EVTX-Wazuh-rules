...
|---|--------|------------|-----------------|-----------------|
| 1 | [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) | `EVTX-ATTACK-SAMPLES` | 49 | 108 |
| 2 | [EVTX-to-MITRE-Attack](https://github.com/mdecrevoisier/EVTX-to-MITRE-Attack) | `EVTX-to-MITRE-Attack` | 13 | 521 |
...
|-----------|------------|-----------------|--------------|
| AutomatedTestingTools | 7 | 49 | `DE_timestomp_and_dll_sideloading_and_RunPersist.evtx`, `rundll32_cmd_schtask.evtx`, `sideloading_injection_persistence_run_key.evtx` +4 more |
| Command and Control | 1 | 4 | `DE_RDP_Tunnel_5156.evtx` |
| Credential Access | 12 | 18 | `CA_4624_4625_LogonType2_LogonProc_chrome.evtx`, `CA_sysmon_hashdump_cmd_meterpreter.evtx`, `Powershell_4104_MiniDumpWriteDump_Lsass.evtx` +9 more |
...
| Privilege Escalation | 6 | 8 | `Sysmon_UACME_39.evtx`, `samaccount_spoofing_CVE-2021-42287_CVE-2021-42278_DC_securitylogs.evtx`, `sysmon_privesc_from_admin_to_system_handle_inheritance.evtx` +3 more |
...
| TA0002-Execution | 3 | 504 | `ID4103-4104-Payload download via PowerShell.evtx`, `ID7000,7009,7045-Payload deployed via service - Tchopper.evtx`, `ID7000,7009,7045-Payload deployed via service - Tchopper.evtx` |
...
| Directory | EVTX Files | Rules Generated | Sample Files |
|-----------|------------|-----------------|--------------|
| (root) | 2382 | 2878 | `win_av_relevant_match.yml`, `win_application_error_lsass_crash.yml`, `win_application_error_msmpeng_crash.yml` +2379 more |
