...
| Directory | EVTX Files | Rules Generated | Sample Files |
|-----------|------------|-----------------|--------------|
| (root) | 2019 | 2453 | `win_security_access_token_abuse.yml`, `win_security_diagtrack_eop_default_login_username.yml`, `win_security_overpass_the_hash.yml` +2016 more |
