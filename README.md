...
|--------|-------|
| Total rules | **84** |
| EVTX files processed | 1,163 across 3 sources |
| Events analyzed | 97,080 |
| MITRE tactics covered | 9 / 12 |
| MITRE techniques | 9 |
| Alert level range | 6 - 13 |
| Validation errors | 0 |
...
# Step 1: Download EVTX samples and Wazuh defaults
...
| JSON export | `.json`, `.jsonl` | EvtxECmd, chainsaw, hayabusa |
...
- Sigma rule integration via pySigma (convert Sigma rules to Wazuh format)
